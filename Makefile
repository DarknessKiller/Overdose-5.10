...
GC_FLAGS += -O3 -mcpu=cortex-a710.cortex-a510+crypto+crc
CL_FLAGS += -O3 -march=armv9-a+nosve -mcpu=cortex-a710+crypto+crc
...
ifneq ($(LLVM),)
KBUILD_CFLAGS += -mcpu=cortex-a510+crypto -mtune=cortex-a510
endif
